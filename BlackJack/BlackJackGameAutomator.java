...
public class BlackJackGameAutomator {
    ...
    private Deck deck; /////////////////////////////////////// not final ???
    private static final int HIT_UNTIL = 16;

    public BlackJackGameAutomator(int numberOfPlayers) {
    ...
    void printHandsAndScore() {
        for (int i = 0; i < hands.length; i++) {
            System.out.print("Hand " + i + " (" + hands[i].score() + "): " + hands[i].score());
            System.out.println();
        }
    }
